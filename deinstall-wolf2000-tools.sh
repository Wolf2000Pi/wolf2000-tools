...
#
echo
echo "   \033[36m deinstaller für Wolf2000-Tools\033[0m"
echo
echo "   \033[36m Author:     Wolf2000\033[0m"
echo "   \033[36m Version:         1.0\033[0m"
echo "   \033[36m https://forum-bpi.de\033[0m"
echo
echo "   \033[32m Wollen sie Wolf2000-Tools Deinstallieren\033[0m"
...
if [ "$answer" != "n" ]
 ...
 cd /usr/bin/ && 
 rm -r omv-install-2.x.sh omv-install-3.x.sh wolf2000-config resize resizea nextcloud
echo
echo
echo "   \033[32m Das wars Wolf2000-Tools ist Deinstalliert\033[0m"
